export const ko = {
  ...
  whyChoose: {
    ...
    advantages: {
      ...
      quality: {
        title: "품질 보증",
        description: "엄격한 테스트와 품질 관리 프로세스로 신뢰할 수 있고 확장 가능하며 유지보수가 용이한 솔루션을 보장합니다."
      },
      support: {
        title: "24/7 지원",
      ...
      security: {
        title: "보안 우선",
        description: "엔터프라이즈급 보안 조치로 데이터를 보호하고 업계 표준 준수를 보장합니다."
      }
    }
  },
  ...
  // Legacy services for backward compatibility
    ...
    web: {
      title: "웹 개발",
      description: "우리는 웹 개발과 웹 디자인 전문가로서 SME부터 MNC까지 기업에 고급 기술 애플리케이션을 제공합니다.",
    ...
    devops: {
      title: "DevOps & 클라우드",
      description: "개발부터 배포까지의 프로세스를 결합. 소프트웨어의 정상적인 기능을 위한 인프라 조건 생성.",
      features: ["CI/CD 파이프라인", "클라우드 인프라", "컨테이너 오케스트레이션", "모니터링 & 로깅"]
    },
    backend: {
      title: "백엔드 개발",
    ...
    automation: {
      title: "프로세스 자동화",
      description: "수동 작업을 줄이고 효율성을 높이는 지능형 자동화 솔루션으로 비즈니스 운영을 간소화.",
      features: ["워크플로우 자동화", "RPA 구현", "비즈니스 프로세스 최적화", "통합 서비스"]
    },
    vision: {
      title: "컴퓨터 비전",
      description: "이미지 인식, 객체 감지, 시각적 데이터 분석을 위한 고급 컴퓨터 비전 솔루션.",
      features: ["이미지 인식", "객체 감지", "얼굴 인식", "시각적 분석"]
    },
    integration: {
      title: "시스템 통합",
      description: "분산된 시스템과 애플리케이션의 원활한 통합으로 통합 비즈니스 솔루션 생성.",
      features: ["API 통합", "데이터 동기화", "레거시 시스템 마이그레이션", "실시간 연결"]
    },
    security: {
      title: "사이버 보안",
      description: "디지털 자산을 보호하고 데이터 개인정보 보호 규정 준수를 보장하는 포괄적인 보안 솔루션.",
      features: ["위협 감지", "데이터 암호화", "접근 제어", "보안 감사"]
    },
    optimization: {
      title: "성능 최적화",
  ...
  technology: {
    ...
    additional: {
      title: "추가 기술 & 혁신 도구",
      subtitle: "최적의 성능을 보장하는 고급 모니터링, 테스트, 통합 솔루션",
      sections: {
        monitoring: "모니터링",
        logManagement: "로그 관리",
        testing: "테스트",
  ...
  tvc: {
    ...
    portfolio: {
      ...
      projects: {
        ...
        product: {
          title: "제품 출시 캠페인",
          description: "판매와 시장 인식을 촉진하는 역동적인 제품 쇼케이스."
        },
        internal: {
          title: "내부 커뮤니케이션",
  ...
  process: {
    ...
    benefits: {
      ...
      transparency: {
        title: "투명한 커뮤니케이션",
        description: "개발의 각 단계에서 정기적인 업데이트와 명확한 커뮤니케이션."
      },
      agile: {
        title: "애자일 방법론",
        description: "반복적 개선과 빠른 피드백을 통한 유연한 개발 접근 방식."
      },
      quality: {
        title: "품질 보증",
        description: "견고하고 신뢰할 수 있는 솔루션을 보장하는 포괄적인 테스트와 품질 검사."
      }
    }
  },
  ...
  faq: {
    title: "자주 묻는 질문",
    subtitle: "서비스와 프로세스에 대한 일반적인 질문에 대한 답변",
    stillHaveQuestions: "아직 질문이 있으신가요?",
    contactTeam: "우리 팀은 프로세스를 이해하고 질문에 답변하는 데 도움을 드릴 준비가 되어 있습니다.",
    questions: {
      tvcTypes: {
        question: "Mercury Solutions는 어떤 유형의 TVC 프로젝트를 전문으로 하나요?",
        answer: "Mercury Solutions는 기업 브랜딩 비디오, 내부 커뮤니케이션, 제품 출시, 이벤트 커버리지를 포함한 광범위한 TVC 프로젝트를 전문으로 합니다. 다양한 산업에서 일하며 HR, Admin, Purchasing 부서에 결과를 가져오는 매력적인 콘텐츠를 만듭니다."
      },
      approach: {
        question: "Mercury Solutions는 TVC 제작에 어떻게 접근하나요?",
        answer: "TVC 제작에 전략적이고 협력적인 접근 방식을 취합니다. 심층 컨설팅으로 시작하여 목표에 부합하는 컨셉을 개발하고, 기술적 우수성으로 실행하며, 고품질 포스트 프로덕션을 보장합니다. 모든 프로젝트가 엔드투엔드 전문성의 혜택을 받습니다."
      },
      custom: {
        question: "Mercury Solutions는 맞춤형 TVC 솔루션을 처리할 수 있나요?",
        answer: "특정 요구사항을 충족하는 맞춤형 TVC 솔루션을 만드는 것을 자랑스러워합니다. 훈련 비디오 시리즈, 기업 브랜드 필름, 제품 쇼케이스가 필요하든 상관없이 정확히 필요한 것을 제공하도록 접근 방식을 조정합니다."
      },
      equipment: {
        question: "Mercury Solutions는 어떤 장비와 기술을 사용하나요?",
        answer: "4K 및 6K 카메라, 고급 조명 시스템, Davinci Resolve와 같은 업계 선도 포스트 프로덕션 소프트웨어를 포함한 최첨단 장비를 활용합니다. 기술적 역량으로 TVC 프로젝트의 최고 품질 출력을 보장합니다."
      },
      timeline: {
        question: "일반적인 TVC 프로젝트는 얼마나 걸리나요?",
        answer: "프로젝트 타임라인은 복잡성과 범위에 따라 다릅니다. 간단한 기업 비디오는 2-3주가 걸릴 수 있고, 여러 위치와 포스트 프로덕션 효과가 포함된 복잡한 TVC는 6-8주가 걸릴 수 있습니다. 컨설팅 단계에서 상세한 타임라인을 제공합니다."
      },
      difference: {
        question: "Mercury Solutions를 다른 TVC 제작 회사와 구별하는 것은 무엇인가요?",
        answer: "기술적 전문성, 크리에이티브 우수성, 전략적 비즈니스 이해의 고유한 조합이 우리를 차별화합니다. 우리는 단순히 아름다운 비디오를 만드는 것이 아니라 비즈니스 결과를 촉진하고 브랜드 포지셔닝을 향상시키는 전략적 콘텐츠를 만듭니다."
      },
      budget: {
        question: "TVC 프로젝트의 일반적인 예산 범위는 얼마인가요?",
        answer: "TVC 프로젝트 예산은 범위, 복잡성, 제작 요구사항에 따라 크게 다릅니다. 간단한 기업 비디오는 일반적으로 $5,000-$15,000, 고급 TVC 제작은 $20,000-$100,000+ 범위입니다. 투명성과 가치를 보장하기 위해 컨설팅에서 상세한 비용 분석을 제공합니다."
      },
      revisions: {
        question: "TVC 서비스에는 몇 번의 수정이 포함되어 있나요?",
        answer: "완전한 만족을 보장하기 위해 표준 TVC 패키지에 2-3회 수정을 포함합니다. 추가 수정은 합리적인 요금으로 이용 가능합니다. 비전과 목표에 부합하는 완벽한 최종 제품을 달성하기 위해 협력적 피드백을 믿습니다."
      },
      delivery: {
        question: "최종 TVC는 어떤 형식으로 배포되나요?",
        answer: "방송 준비 HD/4K 파일, 웹 최적화 버전, 소셜 미디어 형식, 모바일 친화적 버전을 포함한 여러 형식으로 최종 TVC 프로젝트를 배포합니다. 모든 플랫폼에서의 호환성을 보장하고 각 배포 형식에 대한 상세 사양을 제공합니다."
      },
      rights: {
        question: "제작 후 TVC 콘텐츠의 권리는 누가 소유하나요?",
        answer: "전액 지불 후, 최종 TVC 콘텐츠의 모든 권리를 소유합니다. 우리는 포트폴리오에서 작업을 보여줄 권리만 유지합니다. 명확한 라이선스 계약을 제공하고 특정 요구사항에 따라 독점권 또는 확장 사용 조건에 대해 논의할 수 있습니다."
      }
    }
  },
  ...
  // Footer
  footer: {
    description: "Mercury Solutions에서는 SME부터 MNC까지 기업에 더 나은 관리 솔루션을 제공하기 위한 컴퓨터 비전과 데이터 시각화 구현에 중점을 둡니다.",
    services: "서비스",
    quickLinks: "빠른 링크",
  ...
  map: {
    title: "찾아오시는 길",
    subtitle: "하노이 기술 지구 중심에 있는 우리 사무실을 방문하세요",
    officeAddress: {
      title: "사무실 주소",
      address: "33/41 Thái Hà, Đống Đa, Hà Nội, Việt Nam",
      description: "하노이 기술 지구 중심에 위치"
    },
    contact: {
      phone: "전화",
      email: "이메일",
      businessHours: "영업시간",
      weekdays: "월-금: 8:00-18:00",
      saturday: "토: 9:00-13:00"
    },
    directions: {
      title: "오시는 방법",
      bus: "버스: 01, 02, 03번 노선으로 Thái Hà역까지",
      taxi: "택시: 운전사에게 \"33/41 Thái Hà, Đống Đa\"라고 말씀하세요",
      motorbike: "오토바이: 호안끼엠 호수에서 10분",
      parking: "주차: 현장 및 인근에서 이용 가능"
    },
    loading: "지도를 불러오는 중..."
  },
